...
int main() {
    ...
    while (running) {
        ...
        int ch = getchar();
        switch (ch) {
            case 'e': enable_drive(); break;
            case 'x': disable_drive(); break;
            case 'r': reset_fault(); break;
            case 's': move_pos += 100; move_to_position(move_pos); break;
            case 'g': move_pos -= 100; move_to_position(move_pos); break;
